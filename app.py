...
st.warning("⚠️ PRO TIP: ဖိုင်အရွယ်အစား ကြီးလွန်းပါက အပိုင်းခွဲ၍ဖြစ်စေ၊ အတိုဆုံးတင်၍ဖြစ်စေ အသုံးပြုနိုင်ပါသည်။")

# File Uploader for Video
uploaded_file = st.file_uploader("📁 ဗီဒီယိုဖိုင်တင်ရန် (Upload video)", type=["mp4", "mov", "avi", "mkv", "mp3", "wav"])
...
if generate_btn:
    if uploaded_file is not None:
        st.success("ဗီဒီယိုဖိုင် လက်ခံရရှိပါပြီ။ AI မှ Script ထုတ်လုပ်နေပါပြီ...")
    else:
        st.error("ကျေးဇူးပြု၍ ဗီဒီယိုဖိုင် (သို့) အသံဖိုင်ကို ဦးစွာတင်ပါရန်။")
